...
const AddModel = ({ initialValues, ...props }: any) => {
	...
	const [insertModelData, setInsertModelData] = useState<ModelInput>(initialValues);
	const [modelBrand, setModelBrand] = useState<ModelBrand[]>(Object.values(ModelBrand));0
	...
	const [modelCurrency, setModelCurrency] = useState<ModelCurrency[]>(Object.values(ModelCurrency));
	const [modelColour, setModelColour] = useState<ModelColour[]>(Object.values(ModelColour));
	const [modelTransmission, setModelTransmission] = useState<ModelTransmission[]>(Object.values(ModelTransmission));
	const [modelFuelType, setModelFuelType] = useState<ModelFuelType[]>(Object.values(ModelFuelType));
	const [modelOdoUnit, setModelOdoUnit] = useState<ModelOdoUnit[]>(Object.values(ModelOdoUnit));
	const [modelUlezCompliance, setModelUlezCompliance] = useState<ModelULEZCompliance[]>(Object.values(ModelULEZCompliance));
	...
	useEffect(() => {
		setInsertModelData({
			...insertModelData,
            modelBrand: getModelData?.getModel ? getModelData?.getModel?.modelBrand : '',
			modelTitle: getModelData?.getModel ? getModelData?.getModel?.modelTitle : '',
            modelType: getModelData?.getModel ? getModelData?.getModel?.modelType : '',
			modelPrice: getModelData?.getModel ? getModelData?.getModel?.modelPrice : 0,
            modelYear: getModelData?.getModel ? getModelData?.getModel?.modelYear : 0,
			modelLocation: getModelData?.getModel ? getModelData?.getModel?.modelLocation : '',
			modelAddress: getModelData?.getModel ? getModelData?.getModel?.modelAddress : '',
			modelCurrency: getModelData?.getModel ? getModelData?.getModel?.modelCurrency : '',
			modelColour: getModelData?.getModel ? getModelData?.getModel?.modelColour : '',
			modelTransmission: getModelData?.getModel ? getModelData?.getModel?.modelTransmission : '',
			modelFuelType: getModelData?.getModel ? getModelData?.getModel?.modelFuelType : '',
			modelOdometer: getModelData?.getModel ? getModelData?.getModel?.modelOdometer : 0,
			modelOdoUnit: getModelData?.getModel ? getModelData?.getModel?.modelOdoUnit : '',
			modelUlezCompliance: getModelData?.getModel ? getModelData?.getModel?.modelUlezCompliance : '',
			modelImages: getModelData?.getModel ? getModelData?.getModel?.modelImages : [],
		});
	}, [getModelLoading, getModelData]);
	...
	async function uploadImages() {
		try {
			...
			setInsertModelData({ ...insertModelData, modelImages: responseImages });
		} catch (err: any) {
	...
	const doDisabledCheck = () => {
		if (
														   // @ts-ignore
			insertModelData.modelBrand === '' 			|| // @ts-ignore
			insertModelData.modelType === '' 			|| // @ts-ignore
			insertModelData.modelTitle === '' 			||
			insertModelData.modelPrice === 0 			|| // @ts-ignore
			insertModelData.modelYear === 0 			||
			insertModelData.modelAddress === '' 		|| // @ts-ignore
			insertModelData.modelCurrency === '' 		|| // @ts-ignore
			insertModelData.modelColour === '' 			|| // @ts-ignore
			insertModelData.modelTransmission === '' 	|| // @ts-ignore
			insertModelData.modelFuelType === '' 		||
			insertModelData.modelOdometer === 0 		|| // @ts-ignore
			insertModelData.modelOdoUnit === '' 		|| // @ts-ignore
			insertModelData.modelUlezCompliance === '' 	||
			insertModelData.modelDesc === '' 			||
			insertModelData.modelImages.length === 0
		) {
			return true;
		}
	};
	...
	if (device === 'mobile') {
		return <div>ADD NEW MODEL MOBILE PAGE</div>;
	} else {
		return (
			<div id="add-model-page">
				<Stack className="main-title-box">
					<Typography className="main-title">Add New Model</Typography>
					...
					<Stack className="config">
						<Stack className="description-box">
							...
							<Stack className="config-row">
								<Stack className="price-year-after-price">
									...
									<select
										...
										defaultValue={insertModelData.modelBrand || 'select'}
										value={insertModelData.modelBrand || 'select'}
										onChange={({ target: { value } }) =>
											// @ts-ignore
											setInsertModelData({ ...insertModelData, modelBrand: value })
										}
									>
										<>
								...
								<Stack className="price-year-after-price">
									...
									<select
										className={'select-description'}
										defaultValue={insertModelData.modelType || 'select'}
										value={insertModelData.modelType || 'select'}
										onChange={({ target: { value } }) =>
											// @ts-ignore
											setInsertModelData({ ...insertModelData, modelType: value })
										}
									>
										<>
											<option selected={true} disabled={true} value={'select'}>
							...
							<Stack className="config-column">
								...
								<input
									...
									placeholder={'Title'}
									value={insertModelData.modelTitle}
									onChange={({ target: { value } }) =>
										setInsertModelData({ ...insertModelData, modelTitle: value })
									}
								/>
							</Stack>
							...
							<Stack className="config-row">
								<Stack className="price-year-after-price">
									...
									<input
										...
										className="description-input"
										placeholder={'Price'}
										value={insertModelData.modelPrice}
										onChange={({ target: { value } }) =>
											setInsertModelData({ ...insertModelData, modelPrice: parseInt(value) })
										}
									/>
								</Stack>
								<Stack className="price-year-after-price">
									<Typography className="title">Select Currency</Typography>
									<select
										className={'select-description'}
										defaultValue={insertModelData.modelBrand || 'select'}
										value={insertModelData.modelCurrency || 'select'}
										onChange={({ target: { value } }) =>
											// @ts-ignore
											setInsertModelData({ ...insertModelData, modelCurrency: value })
										}
									>
										<>
											<option selected={true} disabled={true} value={'select'}>
											...
											{modelCurrency.map((currency: any) => (
							...
							<Stack className="config-row">
								<Stack className="price-year-after-price">
									...
									<select
										className={'select-description'}
										defaultValue={insertModelData.modelLocation || 'select'}
										value={insertModelData.modelLocation || 'select'}
										onChange={({ target: { value } }) =>
											// @ts-ignore
											setInsertModelData({ ...insertModelData, modelLocation: value })
										}
									>
										<>
											<option selected={true} disabled={true} value={'select'}>
											...
											{modelLocation.map((location: any) => (
								...
								<Stack className="price-year-after-price">
									...
									<input
										...
										className="description-input"
										placeholder={'Address'}
										value={insertModelData.modelAddress}
										onChange={({ target: { value } }) =>
											setInsertModelData({ ...insertModelData, modelAddress: value })
										}
									/>
								</Stack>
							</Stack>
							...
							<Stack className="config-row">
								<Stack className="price-year-after-price">
									...
									<input
										...
										className="description-input"
										placeholder={'Price'}
										value={insertModelData.modelOdometer}
										onChange={({ target: { value } }) =>
											setInsertModelData({ ...insertModelData, modelOdometer: parseInt(value) })
										}
									/>
								</Stack>
								<Stack className="price-year-after-price">
									<Typography className="title">Select OdoUnit</Typography>
									<select
										className={'select-description'}
										defaultValue={insertModelData.modelBrand || 'select'}
										value={insertModelData.modelOdoUnit || 'select'}
										onChange={({ target: { value } }) =>
											// @ts-ignore
											setInsertModelData({ ...insertModelData, modelOdoUnit: value })
										}
									>
										<>
											<option selected={true} disabled={true} value={'select'}>
								...
								<Stack className="price-year-after-price">
									...
									<select
										className={'select-description'}
										value={insertModelData.modelYear || 'select'}
										defaultValue={insertModelData.modelYear || 'select'}
										onChange={({ target: { value } }) =>
											setInsertModelData({ ...insertModelData, modelYear: parseInt(value) })
										}
									>
							...
							<Stack className="config-row">
								<Stack className="price-year-after-price">
									<Typography className="title">Select Colour</Typography>
									<select
										className={'select-description'}
										defaultValue={insertModelData.modelBrand || 'select'}
										value={insertModelData.modelColour || 'select'}
										onChange={({ target: { value } }) =>
											// @ts-ignore
											setInsertModelData({ ...insertModelData, modelColour: value })
										}
									>
										<>
											<option selected={true} disabled={true} value={'select'}>
								...
								<Stack className="price-year-after-price">
									<Typography className="title">Select Transmission</Typography>
									<select
										className={'select-description'}
										defaultValue={insertModelData.modelTransmission || 'select'}
										value={insertModelData.modelTransmission || 'select'}
										onChange={({ target: { value } }) =>
											// @ts-ignore
											setInsertModelData({ ...insertModelData, modelTransmission: value })
										}
									>
										<>
											<option selected={true} disabled={true} value={'select'}>
											...
											{modelTransmission.map((cvt: any) => (
												<option value={`${cvt}`} key={cvt}>
													{cvt}
												</option>
											))}
										</>
								...
								<Stack className="price-year-after-price">
									<Typography className="title">Select Fuel Type</Typography>
									<select
										className={'select-description'}
										defaultValue={insertModelData.modelFuelType || 'select'}
										value={insertModelData.modelFuelType || 'select'}
										onChange={({ target: { value } }) =>
											// @ts-ignore
											setInsertModelData({ ...insertModelData, modelFuelType: value })
										}
									>
										<>
											<option selected={true} disabled={true} value={'select'}>
								...
								<Stack className="price-year-after-price">
									<Typography className="title">Select ULEZ</Typography>
									<select
										className={'select-description'}
										defaultValue={insertModelData.modelUlezCompliance || 'select'}
										value={insertModelData.modelUlezCompliance || 'select'}
										onChange={({ target: { value } }) =>
											// @ts-ignore
											setInsertModelData({ ...insertModelData, modelUlezCompliance: value })
										}
									>
										<>
											<option selected={true} disabled={true} value={'select'}>
											...
											{modelUlezCompliance.map((ulez: any) => (
												<option value={`${ulez}`} key={ulez}>
													{ulez}
												</option>
											))}
										</>
							...
							<Typography className="model-title">Model Description</Typography>
							<Stack className="config-column">
								...
								<textarea
									...
									value={insertModelData.modelDesc}
									onChange={({ target: { value } }) =>
										setInsertModelData({ ...insertModelData, modelDesc: value })
									}
								></textarea>
							</Stack>
						</Stack>
						...
						<Stack className="images-box">
							...
							<Stack className="gallery-box">
								{insertModelData?.modelImages.map((image: string) => {
						...
						<Stack className="buttons-row">
							{router.query.propertyId ? (
								<Button className="next-button" disabled={doDisabledCheck()} onClick={updateModelHandler}>
									<Typography className="next-button-text">Save</Typography>
								</Button>
							) : (
								<Button className="next-button" disabled={doDisabledCheck()} onClick={insertModelHandler}>
									<Typography className="next-button-text">Save</Typography>
								</Button>
							)}
						</Stack>
