					...
					<Stack className={'section'} style={{ height: user.memberType === 'AGENT' ? '228px' : '153px' }}>
						...
						<List className={'sub-section'}>
							{user.memberType === 'AGENT' && (
								<>
									<ListItem className={pathname === 'addModel' ? 'focus' : ''}>
										<Link
											href={{
												pathname: '/mypage',
												query: { category: 'addModel' },
											}}
											scroll={false}
										>
									...
									<ListItem className={pathname === 'myModels' ? 'focus' : ''}>
										<Link
											href={{
												pathname: '/mypage',
												query: { category: 'myModels' },
											}}
											scroll={false}
										>
											<div className={'flex-box'}>
							...
							<ListItem className={pathname === 'myOrders' ? 'focus' : ''}>
								<Link
										...
										>
											<div className={'flex-box'}>
												{category === 'myOrders' ? (
													<img className={'com-icon'} src={'/img/icons/orderWhite.svg'} alt={'com-icon'} />
												) : (
													<img className={'com-icon'} src={'/img/icons/order.svg'} alt={'com-icon'} />
												)}
												<Typography className={'sub-title'} variant={'subtitle1'} component={'p'}>
													My Orders
												</Typography>
