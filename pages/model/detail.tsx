...
const ModelDetail: NextPage = ({ initialComment, ...props }: any) => {
	...
	const [destinationModel, setDestinationModel] = useState<Model[]>([]);
						...
						<Stack className={'model-info-config'}>
							<Stack className={'info'}>
								<Stack className={'left-box'}>
									...
									<Typography className={'title-main'}>{moment(model?.createdAt).format('YYYY')} Ferrari California T Auto</Typography>
									<Stack className={'top-box'}>
										<Typography className={'city'}>VIC • Dealer used location</Typography>
										...
										<Typography className={'date'}>123 days ago</Typography> {/**{moment().diff(model?.createdAt, 'days')} */}
									</Stack>
								</Stack>
										...
										<Stack className="button-box">
											...
											{/* ) : ( */}
												<FavoriteBorderIcon
													fontSize={'medium'}
													// @ts-ignore
													onClick={() => likePropertyHandler(user, model?._id)}
												/>
											{/* )} */}
											<Typography>modelLikes</Typography>
										</Stack>
									</Stack>
									<Typography className={'price'}>$238,888</Typography>
								</Stack>
							</Stack>
							<Stack className={'images'}>
								...
								<Stack className={'sub-images'}>
									...
									<Stack className={'sub-img-box'}>
										<img src={'/img/banner/header2.jpg'} alt={'sub-image'} />
									</Stack>
									<Stack className={'sub-img-box'}>
										<img src={'/img/banner/header3.svg'} alt={'sub-image'} />
									</Stack>
									<Stack className={'sub-img-box'}>
										<img src={'/img/banner/header4.svg'} alt={'sub-image'} />
									</Stack>
									<Stack className={'sub-img-box'}>
										<img src={'/img/banner/header5.jpg'} alt={'sub-image'} />
									</Stack>
								</Stack>
							</Stack>
						</Stack>
							...
							<Stack className={'left-config'}>
								<Stack className={'options-config'}>
									...
									<Stack className={'option'}>
										...
										<Stack className={'option-includes'}>
											...
											<Typography className={'option-data'}>{model?.modelOdoMeter ?? "N/A"}</Typography>
										</Stack>
									</Stack>
									<Stack className={'option'}>
										<Stack className={'svg-box'}>
								...
								<Stack className={'prop-desc-config'}>
									<Stack className={'top'}>
										...
										<Typography className={'desc'}>{model?.modelTitle ?? 'No Description!'}</Typography>
									</Stack>
									<Stack className={'bottom'}>
										<Typography className={'title'}>Car details<span className="pluto">ø</span></Typography>
						...
						{destinationModel.length !== 0 && (
							<Stack className={'similar-models-config'}>
								...
								<Stack className={'cards-box'}>
									...
									>
										{destinationModel.map((model: Model) => {
											return (
